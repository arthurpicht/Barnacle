...
public abstract class TypeMapper {
	...
	public static TypeMapper getInstance(BarnacleInitializer.Dialect dialect) {
		if (dialect == BarnacleInitializer.Dialect.MYSQL) {
			return new TypeMapperMySQL();
		} else if (dialect == BarnacleInitializer.Dialect.H2) {
